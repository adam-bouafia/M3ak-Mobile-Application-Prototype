...
import 'package:m3ak_app/Dashboard/ContactScreens/phonebook_view.dart';
import 'package:m3ak_app/Dashboard/Home.dart';
import 'package:m3ak_app/Dashboard/ContactScreens/MyContacts.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Future<bool> sendAlertSMS(bool isAlert) async {
              ...
              children: [
                ...
                Container(
                  ...
                  child: PinPut(
                    ...
                    fieldsCount: 4,
                    onSubmit: (String pin) =>
                        _trySendAlertSms(pin, context, userPin),
  ...
  void _trySendAlertSms(String pin, BuildContext context, int userPin) {
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                  ...
                  child: Image.asset("assets/phone_red.png", height: 30)),
            ],
          ),
        ),
      ),
