...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void checkService() async {
    ...
    switchAudioRecord = (await SharedPreferences.getInstance()).getBool("bgRecord")??false  ;
    switchValue = (await SharedPreferences.getInstance()).getBool("smsSend")??false  ;
    switch (switchAudioRecord) {
      case true : AudioBackgroundRecord.getInstance()
          .startRecordingService() ;
      break ;
      case false : AudioBackgroundRecord.getInstance()
      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(
            ...
            title: Text("Audio Record"), //TODO Translation
          ...
          Divider(
            ...
            endIndent: 40,
                  ...
                  ListTile(
                    trailing: IconButton(icon: Icon(Icons.keyboard_arrow_right), onPressed: () {_selectDirectory(context);
                      },
                    ),
                  leading: CircleAvatar(
                  backgroundColor: Colors.grey[200],
                  ...
                  child: Image.asset("assets/directory.png",height: 24),
                    ...
                    subtitle: Text("change audio record directory where you wish you want:".tr),
          ),
          Divider(
            indent: 40,
            endIndent: 40,
          ...
          ListTile(
            trailing: IconButton(icon: Icon(Icons.keyboard_arrow_right),  onPressed: () async {
              showDurationPicker(
                  context: context,
                  initialDuration: Duration(
                      ...
                      // seconds: 54,
                      // milliseconds: 23,
                      milliseconds:  await AudioBackgroundRecord.getInstance().getMaxRecordDuration()
                    ),
                ...
                if(value !=null )
                  await AudioBackgroundRecord.getInstance()
                     .configure(maxDurationInMillis: value.inMilliseconds, ) ;
              });
            },
            ),
            leading: CircleAvatar(
          ...
          Padding(
            ...
            child: Text(
              "sfdes".tr,
              style: TextStyle(fontFamily: 'metaplusmedium',color: Colors.grey),
            ),
          ),
          Row(
            children: [
